 ...
 */
export interface MethodPortal {
  info:     Info;
  item:     MethodPortalItem[];
  auth:     Auth;
  event:    MethodPortalEvent[];
  variable: Variable[];
}
...
export interface MethodPortalEvent {
  listen: string;
  script: PurpleScript;
}

export interface PurpleScript {
  id:   string;
  type: string;
  exec: string[];
}
...
export interface MethodPortalItem {
  name:        string;
  item:        ItemItem[];
  description: string;
}
...
export interface TransformCollectionFromFormatV1ToV2 {
  variables: any[];
  info:      Info;
  item:      TransformCollectionFromFormatV1ToV2Item[];
}

export interface TransformCollectionFromFormatV1ToV2Item {
  name:     string;
  event?:   ItemEvent[];
...
export namespace Convert {
  export function toMethodPortal(json: string): MethodPortal {
      return JSON.parse(json);
  }

  export function methodPortalToJson(value: MethodPortal): string {
      return JSON.stringify(value);
  }

  export function toBasicAuth(json: string): BasicAuth {
      return JSON.parse(json);
  }

  export function basicAuthToJson(value: BasicAuth): string {
      return JSON.stringify(value);
  }

  export function toOAuth10VerifySignature(json: string): OAuth10VerifySignature {
      return JSON.parse(json);
  }

  export function oAuth10VerifySignatureToJson(value: OAuth10VerifySignature): string {
      return JSON.stringify(value);
  }

  export function toHawkAuth(json: string): HawkAuth {
      return JSON.parse(json);
  }

  export function hawkAuthToJson(value: HawkAuth): string {
      return JSON.stringify(value);
  }

  export function toSetCookies(json: string): SetCookies {
      return JSON.parse(json);
  }

  export function setCookiesToJson(value: SetCookies): string {
      return JSON.stringify(value);
  }

  export function toGetCookies(json: string): GetCookies {
      return JSON.parse(json);
  }

  export function getCookiesToJson(value: GetCookies): string {
      return JSON.stringify(value);
  }

  export function toDeleteCookies(json: string): DeleteCookies {
      return JSON.parse(json);
  }

  export function deleteCookiesToJson(value: DeleteCookies): string {
      return JSON.stringify(value);
  }

  export function toRequestHeaders(json: string): RequestHeaders {
      return JSON.parse(json);
  }

  export function requestHeadersToJson(value: RequestHeaders): string {
      return JSON.stringify(value);
  }

  export function toResponseHeaders(json: string): ResponseHeaders {
      return JSON.parse(json);
  }

  export function responseHeadersToJson(value: ResponseHeaders): string {
      return JSON.stringify(value);
  }

  export function toResponseStatusCode(json: string): ResponseStatusCode {
      return JSON.parse(json);
  }

  export function responseStatusCodeToJson(value: ResponseStatusCode): string {
      return JSON.stringify(value);
  }

  export function toDelayResponse(json: string): DelayResponse {
      return JSON.parse(json);
  }

  export function delayResponseToJson(value: DelayResponse): string {
      return JSON.stringify(value);
  }

  export function toTimestampValidity(json: string): TimestampValidity {
      return JSON.parse(json);
  }

  export function timestampValidityToJson(value: TimestampValidity): string {
      return JSON.stringify(value);
  }

  export function toTransformCollectionFromFormatV1ToV2(json: string): TransformCollectionFromFormatV1ToV2 {
      return JSON.parse(json);
  }

  export function transformCollectionFromFormatV1ToV2ToJson(value: TransformCollectionFromFormatV1ToV2): string {
      return JSON.stringify(value);
  }

  export function toTransformCollectionFromFormatV2ToV1(json: string): TransformCollectionFromFormatV2ToV1 {
      return JSON.parse(json);
  }

  export function transformCollectionFromFormatV2ToV1ToJson(value: TransformCollectionFromFormatV2ToV1): string {
      return JSON.stringify(value);
  }
}
